...
I am currently a Software Developer Intern at **Endoo (by Endare)** in **Ghent** (Feb 2026 – May 2026).

- 🛠️ **Internship Project:** Building a custom documentation/manual module integrated into the **Odoo platform** (similar to the manual.to concept).
- 💻 **Active Stack:** Working daily with **Python**, **XML**, **PostgreSQL**, and **Bootstrap**.
...
### ⚡ Fun Fact
* 🎸 **Music:** I play the bass guitar.
* 🏌️‍♂️ **Sports:** You can find me on the golf course on the weekends.
